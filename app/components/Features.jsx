...
const Features = () => {
  return (
    <section className="mt-6 md:mt-0 py-6 md:py-12 bg-[#ebeef1]">
      <div className="container mx-auto px-6 sm:px-8 md:max-w-[1100px]">
        <div className="flex flex-col md:flex-row items-start justify-between gap-6 md:gap-12">
          ...
          {/* Right Column - Image */}
          <div className="w-full md:flex-1 relative flex items-center justify-center pt-8 md:pt-0 md:mt-[60px]">
